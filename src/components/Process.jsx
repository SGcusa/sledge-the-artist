    ...
    <section id="process" className="py-20 px-8 md:px-16 bg-ink-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-ink-400">
        ...
        <div className="group step-card border-l-2 border-amber transition-colors duration-[5s] ease-in-out">
          ...
          <h3 className="font-medium text-cream mb-2 transition-all duration-[1.5s] ease-in-out group-hover:text-[24px]">Quote & Confirmation</h3>
        ...
        <div className="group step-card border-l-2 border-blue transition-colors duration-[5s] ease-in-out">
          ...
          <h3 className="font-medium text-cream mb-2 transition-all duration-[1.5s] ease-in-out group-hover:text-[24px]">Creation & Updates</h3>
        ...
        <div className="group step-card border-l-2 border-green transition-colors duration-[5s] ease-in-out">
          ...
          <h3 className="font-medium text-cream mb-2 transition-all duration-[1.5s] ease-in-out group-hover:text-[24px]">Delivery</h3>
