    ...
    <footer className="bg-ink-900 px-4 md:px-16 py-10 border-t border-ink-400">
      ...
      <div className="flex flex-wrap justify-center md:justify-between items-center gap-4 pt-6 border-t border-ink-400">
        ...
        <div className="flex gap-6">
          <a href="https://www.instagram.com/gcusaa/" target="_blank" rel="noreferrer" className="text-xs text-ink-200 hover:text-cream tracking-widest uppercase transition-colors">Created by: Gcusaaa</a>
        </div>
      </div>
    </footer>
  );
